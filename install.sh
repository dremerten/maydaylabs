...
# Ask user which Python environment type they are using
echo "Python Environment Setup"
echo "---------------------------"
echo "  1) venv  (standard Python virtual environment)"
echo "  2) conda (Miniconda / Anaconda)"
echo ""
while true; do
  read -rp "Select environment type [1/2]: " ENV_CHOICE
  case "$ENV_CHOICE" in
    1) PYTHON_ENV_TYPE="venv";  break ;;
    2) PYTHON_ENV_TYPE="conda"; break ;;
